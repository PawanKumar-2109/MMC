...
contract Parametric is ChainlinkClient, Ownable {
 ...
 address public insurer;
  ...
  constructor(address payable _client, uint _duration, uint _premium, uint _payoutValue, string memory _cropLocation, string memory _lat, string memory _lon)  payable Ownable() public {
